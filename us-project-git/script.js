...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // применяем текст по текущему языку сразу после загрузки
    updatePageLanguage();
});
...
function updatePageLanguage() {
    // Проходим по всем элементам, которые помечены для перевода
    const keys = translations[currentLanguage] || {};
    ...
    // Прочие атрибуты (title и т.д.) можно добавить по необходимости
